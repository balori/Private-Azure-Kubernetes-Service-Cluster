variable "log_analytics_workspace_name" {
  ...
  default     = "prodAksWorkspace"
  type        = string
}

variable "env" {
  description = "(Required) Specifies the environment of the Container Registry."
  type        = string
  default     = "prod"
}
...
variable "appgw_subnet_name" {
  description = "(Required) Specifies the name of the AppGW subnet."
  default     = "AppGwSubnet"
  type        = string
}

variable "postgres_subnet_address_prefix" {
  description = "Specifies the address prefix of the postgress subnet"
  default     = ["10.0.32.0/21"]
  type        = list(string)
}

variable "postgres_subnet_name" {
  description = "(Required) Specifies the name of the Postgres subnet."
  default     = "PostgresSubnet"
  type        = string
}
...
variable "app_gateway_name" {
  ...
  type        = string
  default     = "ProdApplicationGateway"
}
