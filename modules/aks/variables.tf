...
variable "backend_address_pool_name" {
  description = "Backend Address Pool name for Application Gateway. Changing this forces a new resource to be created."
  type        = string
  default     = "appgw-beap"
}

variable "frontend_port_name" {
  description = "Frontend port name for Application Gateway. Changing this forces a new resource to be created."
  type        = string
  default     = "appgw-feport"
}

variable "frontend_ip_configuration_name" {
  description = "Frontend IP config name for Application Gateway. Changing this forces a new resource to be created."
  type        = string
  default     = "appgw-feip"
}

variable "http_setting_name" {
  description = "http setting name for Application Gateway. Changing this forces a new resource to be created."
  type        = string
  default     = "appgw-be-htst"
}

variable "listener_name" {
  description = "lstener name for Application Gateway. Changing this forces a new resource to be created."
  type        = string
  default     = "appgw-httplstn"
}

variable "request_routing_rule_name" {
  description = "Request routing rule name for Application Gateway. Changing this forces a new resource to be created."
  type        = string
  default     = "appgw-rqrt"
}
...
variable "app_gateway_subnet_name" {
  description = "Request routing rule name for Application Gateway. Changing this forces a new resource to be created."
  type        = string
  default     = "devappgwsubnet"
}

variable "app_gateway_sku" {
  description = "Name of the Application Gateway SKU. Changing this forces a new resource to be created."
  type        = string
  default     = "Standard_v2"
}

variable "vnet_appgwsubnet_id" {
...
variable "aks_vnet_name" {
  description = "The Virtual network name where the Application GateWay should exist. Changing this forces a new resource to be created."
  type        = string
}

variable "app_gateway_name" {
  description = "The Application GateWay name. Changing this forces a new resource to be created."
  type        = string
  default     = "devApplicationGateway"
}